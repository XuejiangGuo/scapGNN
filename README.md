...
# Codes and used
For detailed functions and usage instructions, please refer to https://cran.rstudio.com/web/packages/scapGNN/vignettes/vignette.html. Or use help() after installing scapGNN to see the documentation for each feature.
